...
public class TestFrame {
	...
	public TestFrame () {
        ...
        canvas.addParticle (new Particle (90, 150, 3, 0, 10));
		canvas.addParticle (new Particle (20, 150, 6, 0, 20));
		canvas.addParticle (new Particle (200, 150, -6, 0, 40));
		canvas.addParticle (new Particle (380, 150, 12, 0, 20));
